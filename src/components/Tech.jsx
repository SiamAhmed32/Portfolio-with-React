...
const technologies = {
  ...
  "Front End": [ { name: "React JS", icon: IconReactjs }, { name: "HTML 5", icon: IconHtml }, { name: "CSS 3", icon: IconCss }, { name: "Tailwind CSS", icon: IconTailwind }, { name: "Bootstrap", icon: IconBootstrap }, ],
  "Backend": [ { name: "Next.js", icon: IconNextjs }, { name: "Node JS", icon: IconNodejs }, ],
